...
import android.content.DialogInterface;
	...
	public class Tdbase extends Activity implements Runnable
	{
	    ...
	    private ProgressDialog pd, dialogz, dialoc;
	    private String Str_check2;
	    public String answer, mk;
	    private String url;
	    private String  slong="", slat="";
	    private LocationManager locmgr = null;
		 double longitude, latitude;
		 private TextView longi, lati;
		 public AlertDialog.Builder builder, builderx;
	...
	if(isGPSEnabled)
       ...
       if(locmgr != null){
    	  ...
    	  // dialoc.dismiss();
    	   Toast.makeText(Tdbase.this, "GPS signal acquired", Toast.LENGTH_LONG).show(); 
	        ...
	        String longiz = longi.toString();
	        String latiz = lati.toString();
	   ...
	   /*     if(slong.equals("") || slat.equals("") )
          ...
          //dialogz.show();
           //   handlerx.sendEmptyMessage(1);
            	
            	Toast.makeText(Tdbase.this, "Please Wait, Acquiring GPS signal", Toast.LENGTH_LONG).show();
            }else 
            {
	     ...
	     */   
          ...
          alertbox.setTitle("ERROR");
            ...
            alertbox.setMessage("Dear Market Monitor. Looks like there is an error in Internet Connection. Would you like to submit data via SMS? ");
            ...
            alertbox.setNegativeButton("SMS", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface arg0, int arg1) {
                	...
                	Intent intentz = new Intent(Tdbase.this, Maize.class);
                    startActivity(intentz);
                	
                    Toast.makeText(getApplicationContext(), "Please enter Market name in the field (Market Name)", Toast.LENGTH_SHORT).show();
                }
            });
	        ...
	        //SharedPreferences jinayako = getSharedPreferences("username", MODE_PRIVATE);

	      //  mk=Str_user.getString("username","");
	     /*   if(!Str_user.equals("")){
	        Toast toast=Toast.makeText(this, "jina:"+ Str_user, 2000);
	        toast.setGravity(Gravity.TOP, -30, 50);
	        toast.show();
	        }else if(Str_user.equals("")){
		        //Toast toast=Toast.makeText(this, "jina haiko:", 2000);
		      //  toast.setGravity(Gravity.TOP, -30, 50);
		        //toast.show();
		        }
	  ...
	  //pauses listener while app is inactive
	    ...
	    public void onResume() {
	        ...
	        public void run() {
	        	...
	        	url="http://ratin.arvixevps.com/~ratin/ratin/map_content/mobile/index.php";
	            	                ...
	            	                try {
	            	                	...
	            	                	// preparing data to send
	            		                   ...
	            		                   nameValuePairs.add(new BasicNameValuePair("UserEmail", name.trim()));
	            		                    ...
	            		                    if(buffer.charAt(0)=='Y')
		            		                {
		            		                	...
		            		                	finish();
		            		                	 Intent intent = new Intent(Tdbase.this, MainMenu.class);
	            	                 ...
	            	                 /*  catch (ConnectTimeoutException cte ){
	            		                ...
	            		                catch (Exception e)
	            	                    {
	            		                	...
	            		                	answer="Error in internet connection "+e.toString();
