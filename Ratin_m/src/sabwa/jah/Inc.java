...
public class Inc extends Activity implements Runnable {
	...
	private String answer, tit, mahali, incd,  slong, slat, deviceId, imeiz;
	 ...
	 public Intent intentax, intentpic;
    ...
    public void photo (View view)
    {
        ...
        File file = new File(Environment.getExternalStorageDirectory(), ""+deviceId.trim()+"_M.jpg");
    ...
    {
    	 Intent intent = new Intent(Inc.this, Maize.class);
 ...
 if  (tit.equals("") || mahali.equals("") || incd.equals("")|| slong.equals("") || slat.equals("") )
    ...
    public void run() {
	    ...
	    nameValuePairs.add(new BasicNameValuePair("imei", deviceId.trim()));
		    ...
		    try{
		            ...
		            answer="Data Sent";
		            finish();
		            //intentpic = new Intent(Inc.this, Upload.class);
