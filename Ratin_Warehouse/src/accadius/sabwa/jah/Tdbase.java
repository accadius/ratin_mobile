       ...
       if(locmgr != null){
    	   ...
    	   Toast.makeText(Tdbase.this, "GPS signal acquired", Toast.LENGTH_LONG).show(); 
	        ...
	        // prepare the alert box
	          ...
	          alertbox.setTitle("ERROR");
	            ...
	            alertbox.setMessage("Dear Warehouse Monitor. Looks like there is an error in Internet Connection. Would you like to submit data via SMS? ");
	    ...
	    public void end (View view)
	        ...
	        public void run() {
	        	...
	        	url="http://ratin.arvixevps.com/~ratin/map_content/mobile/whouse_login.php";
